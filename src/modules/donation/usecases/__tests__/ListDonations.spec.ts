import { makeListDonationsUsecase } from "../ListDonations";
import { ListByPayerId } from "../../repositories/__mocks__/DonationRepo";
...
describe("List Donations Usecase", () => {
    ...
    it("should return ok result", async () => {
        const usecase = makeListDonationsUsecase({
            listDonations: ListByPayerId.ok
        });
    ...
    it("should return UnexpectedError when listing donations fails", async () => {
        const usecase = makeListDonationsUsecase({
            listDonations: ListByPayerId.throw
        });
